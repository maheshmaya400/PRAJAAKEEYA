...
<p align="center">
  ...
  <img alt="Languages" src="https://img.shields.io/badge/Languages-English%20%7C%20ಕನ್ನಡ-orange.svg">
  <img alt="Contributions" src="https://img.shields.io/badge/Contributions-Open-purple.svg">
</p>
...
<div align="center">
  <img src="assets/banner/hero-banner.png" alt="PRAJAAKEEYA Hero Banner" width="100%">
</div>
...
<div align="center">
  <img src="assets/images/people-first.png" alt="People First Principle" width="80%">
</div>
...
<div align="center">
  <img src="assets/images/5-step-model.png" alt="5 Step Model" width="80%">
</div>
...
<div align="center">
  <img src="assets/images/comparison.png" alt="Comparison Table" width="80%">
</div>
...
```mermaid
flowchart TD
    A[👤 Citizen] --> B{Civic Engagement}
    B --> C[🔎 Research Candidates]
    C --> D[🗳️ Vote / Selection]
    D --> E[🏛️ Representative Elected]
    E --> F[📊 Continuous Monitoring]
    F --> G{Performance Check}
    G -- ✅ Performing Well --> H[📣 Promotion & Support]
    G -- ⚠️ Needs Improvement --> I[✍️ Correction & Feedback]
    G -- ❌ Non-Performing --> J[🚫 Rejection]
    I --> F
    H --> F
    J --> C
```
...
```mermaid
timeline
    title Evolution of the Prajaakeeya Concept (Educational Overview)
    Pre-Independence : Democratic ideals of public trusteeship discussed in Indian political thought
    Post-1950 : Indian Constitution formalizes representative democracy and accountability mechanisms
    2000s : Rise of citizen-led transparency and RTI (Right to Information) movements
    2020s : Term "Prajaakeeya" popularized in Karnataka's public discourse
    Present : Open-source, digital civic education initiatives like this repository emerge
```
...
<div align="center">
  <img src="assets/images/governance-dashboard.png" alt="Governance Dashboard Concept" width="80%">
</div>
...
<div align="center">
  <img src="assets/images/bilingual-poster.png" alt="Bilingual Educational Poster" width="80%">
</div>
